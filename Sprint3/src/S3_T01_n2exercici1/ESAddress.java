...
public class ESAddress implements Address{
    ...
    public ESAddress(String name, String street, String streetNumber, String floorNumber, String doorNumber, String postCode, String cityTown, String county, String phoneNumber) {
        this.name = name;
        this.street = street;
