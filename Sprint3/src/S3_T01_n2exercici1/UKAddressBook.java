...
public class UKAddressBook implements AddressBookFactory{
    ...
    public Address createAddress(String[] addressData) {
        return new UKAddress(addressData[0], addressData[1],addressData[2], addressData[3], addressData[4], addressData[5], addressData[6], addressData[7], addressData[8], addressData[9]);
    }
